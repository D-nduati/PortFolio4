  ...
  const posts = [
    {
      ...
      readMore: '/blog/microservices-101'
    },
    {
      id: 2,
      ...
      readMore: '/blog/react-optimization'
    },
    {
      id: 3,
    ...
    },
    {
      ...
      readMore: '/blog/jwt-authentication'
    }
  ];
    ...
    <div className={styles.container}>  
      {posts.map(post => (
        <div key={post.id} className={styles.post}>  
          ...
          <a href={post.readMore} className={styles.btn}> 
